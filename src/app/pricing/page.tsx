...
export default function PricingSectionCards() {
  ...
  const prices = {
    startup: !newPrices ? 39 : 399,
    team: !newPrices ? 89 : 749,
    enterprise: !newPrices ? 149 : 999,
  };
  return (
    <>
      {/* Pricing */}
      <div className="container py-24 lg:py-32">
        ...
        <div className="flex justify-center items-center">
          ...
          <Switch
            id="payment-schedule"
            checked={newPrices}
            onCheckedChange={() => setnewPrices(!newPrices)}
          />
        ...
        <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:items-center">
          ...
          <Card className="border-primary">
            <CardHeader className="text-center pb-2">
              ...
              <span className="font-bold text-5xl">£{prices.startup}</span>
            </CardHeader>
          ...
          <Card>
            <CardHeader className="text-center pb-2">
              ...
              <span className="font-bold text-5xl">£{prices.team}</span>
            </CardHeader>
            <CardDescription className="text-center  w-11/12 mx-auto">
          ...
          <Card>
            <CardHeader className="text-center pb-2">
              ...
              <span className="font-bold text-5xl">£{prices.enterprise}</span>
            </CardHeader>
            <CardDescription className="text-center  w-11/12 mx-auto">
